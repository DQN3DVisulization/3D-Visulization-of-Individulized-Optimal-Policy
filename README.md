...
#### Each dot in the 3D interacive space represents an individual customer. Hoovering on it appears the customer's starting state as the DQN model input on that day and the individualized optimal treatment. Each visualization allows you to zoom in/out and rotate in any direction.
